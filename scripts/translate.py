...
translator1 = GoogleTranslator(source="en", target="pl")


def translate(text):
    return translator1.translate(text)
...
if __name__ == "__main__":
    ...
    #Parallel(n_jobs=6, backend="multiprocessing")(delayed(preprocess)(qa_id, row) for qa_id, row in enumerate(tqdm(get_qas(), total=26247)))
